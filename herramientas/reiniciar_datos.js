...
(async()=>{
  ...
  for(const d of docs){
    ...
    else if(k.startsWith('luffy/clientes_')||k==='luffy/clientes'||k==='luffy/membresias'||k==='luffy/paquetes'||k==='luffy/senas'||k==='luffy/sugerencias_paq') cambios.push([k,{list:[]}]);
    else if(k.startsWith('luffy/caja_')) cambios.push([k,{sesiones:[]}]);
    else if(k==='luffy/estado_caja') cambios.push([k,{}]);
